...
- Interface design (Outline interface components - Define each component's role, behaviour, relation to other) (1 page max)
  ...
  - Επιγραμματικά τα interface components:
    ...
    3. Ετικέτα STOP
      a. για να ενημερώνει τον χρήστη, υποδεικνύει τι πρέπει να κάνει ο χρήστης όταν ανάβει το κόκκινο φωτάκι
    
    4. Οδηγίες χρήσης
      a. για να ενημερώνει τον χρήστη, σχετικά με την λειτουργία του αντικειμένου
      b. Ετικέτα κολλημένα στην περιοχή του STAND
    
    5. STAND (που θα έχει όλα αυτά μέσα)
      a.Υποστήριξη του όλου συστήματος
